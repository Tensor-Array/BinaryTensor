...
void* operator new(size_t, binary_tensor::devices::Device);

void* operator new(size_t, binary_tensor::devices::Device, void*);

void operator delete(void*, binary_tensor::devices::Device);

void operator delete(void*, binary_tensor::devices::Device, void*);
