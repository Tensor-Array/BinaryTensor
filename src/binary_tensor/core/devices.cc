...
void* operator new(size_t count, binary_tensor::devices::Device dev)
{
	int temp;
	void* m_alloc_dat;
	switch (dev.dev_t)
	{
	case binary_tensor::devices::CPU:
		m_alloc_dat = std::malloc(count);
		break;
	case binary_tensor::devices::CUDA:
	{
...
void* operator new(size_t count, binary_tensor::devices::Device dev, void* stream)
{
	int temp;
	void* m_alloc_dat;
	switch (dev.dev_t)
...
void operator delete(void* data, binary_tensor::devices::Device dev)
{
	int temp;
	switch (dev.dev_t)
	{
...
void operator delete(void* data, binary_tensor::devices::Device dev, void* stream)
{
	int temp;
	switch (dev.dev_t)
	{
